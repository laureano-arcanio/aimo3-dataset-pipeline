...
\title{\Huge\bfseries P01 Divisible Floor Sums}
\author{\Large Laureano Arcanio \quad \large (February 2026)}
\date{}
\maketitle
\section*{Problem}

For a real value \(\alpha\), define for each positive integer \(n\)
\[
...
Let \(B=180{,}000\). Determine the number of balanced real numbers \(\alpha\) in the interval \([0,B]\).
...
With \(B=180{,}000\), the balanced numbers in \([0,B]\) are
\[
0,2,4,\dots,180{,}000 = 2\cdot 90{,}000.
\]
There are \(90{,}000-0+1=90{,}001\) such numbers.
