...
\title{\Huge\bfseries P03 Monomial Radical Sum V3}
...
$x_2,x_5,x_11,x_13$ with nonnegative integer exponents (including the monomial $1$).
...
The normalization $F(x_2)=32$ gives
\[
2^k=32,
\]
so $k=5$. Hence
...
Now $P=x_2x_5x_11x_13$ is squarefree, and its monomial divisors correspond to all
subsets of $\{x_2,x_5,x_11,x_13\}$. Therefore,
\[
\sum_{D\mid P} F(D)
=\sum_{S\subseteq\{2,5,11,13\}}\left(\prod_{p\in S} p\right)^5
=\prod_{p\in\{2,5,11,13\}}(1+p^5).
\]
Computing,
\[
(1+2^5)(1+5^5)(1+11^5)(1+13^5)
=33\cdot 3126\cdot 161052\cdot 371294
=6168605079987504.
\]
...
The condition $F(x_2)=32$ yields $k=5$, so again $F(M)=\mathrm{rad}(M)^5$.
