...
\title{\Huge\bfseries P08 Unique Step Permutation V2}
...
1,2,\dots,2N-1.
\]
A route is any permutation \((t_1,t_2,\dots,t_{2N-1})\) of these points.
...
\tag{7}
\]
Because \(N=85{,}003\) is odd, \(N-1\) is even, so \((N-1)(2N-1)\) is even and hence
\[
t_1+t_{2N-1}\equiv 0\pmod 2.
\tag{8}
\]

\subsection*{4. Impossibility below \(42{,}503\)}
Here \(N+1=85{,}004\). From (6),
\[
t_1+t_{2N-1}\ge 85{,}004.
\tag{9}
\]
If \(\max(t_1,t_{2N-1})\le 42{,}502\), then \(t_1+t_{2N-1}\le 85{,}004\).
So equality holds and forces \(t_1=t_{2N-1}=42{,}502\), impossible in a permutation.
Therefore
\[
\max(t_1,t_{2N-1})\ge 42{,}503.
\tag{10}
\]
