...
\title{\Huge\bfseries P08 All Distances Different V3}
...
\tag{7}
\]
Because \(N=95{,}005\) is odd, \(N-1\) is even, so \((N-1)(2N-1)\) is even and hence
\[
t_1+t_{2N-1}\equiv 0\pmod 2.
\tag{8}
\]

\subsection*{4. Impossibility below \(47{,}504\)}
Here \(N+1=95{,}006\). From (6),
\[
t_1+t_{2N-1}\ge 95{,}006.
\tag{9}
\]
If \(\max(t_1,t_{2N-1})\le 47{,}503\), then \(t_1+t_{2N-1}\le 95{,}006\).
So equality holds and forces \(t_1=t_{2N-1}=47{,}503\), impossible in a permutation.
Therefore
\[
\max(t_1,t_{2N-1})\ge 47{,}504.
\tag{10}
\]
