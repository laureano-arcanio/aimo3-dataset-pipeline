...
\title{\Huge\bfseries P08 Distinct Distance Route V1}
...
\tag{7}
\]
Because \(N=75{,}001\) is odd, \(N-1\) is even, so \((N-1)(2N-1)\) is even and hence
\[
t_1+t_{2N-1}\equiv 0\pmod 2.
\tag{8}
\]

\subsection*{4. Impossibility below \(37{,}502\)}
Here \(N+1=75{,}002\). From (6),
\[
t_1+t_{2N-1}\ge 75{,}002.
\tag{9}
\]
If \(\max(t_1,t_{2N-1})\le 37{,}501\), then \(t_1+t_{2N-1}\le 75{,}002\).
So equality holds and forces \(t_1=t_{2N-1}=37{,}501\), impossible in a permutation.
Therefore
\[
\max(t_1,t_{2N-1})\ge 37{,}502.
\tag{10}
\]
