...
\title{\Huge\bfseries Linear Path with Distinct Step Sizes}
...
\tag{7}
\]
Because \(N=75{,}000\) is odd, \(N-1\) is even, so \((N-1)(2N-1)\) is even and hence
\[
t_1+t_{2N-1}\equiv 0\pmod 2.
\tag{8}
\]

\subsection*{4. Impossibility below \(37{,}501\)}
Here \(N+1=75{,}001\). From (6),
\[
