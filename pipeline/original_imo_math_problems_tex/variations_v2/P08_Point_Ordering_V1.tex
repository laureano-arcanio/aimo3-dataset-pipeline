...
\title{\Huge\bfseries Point Ordering with Unique Consecutive Gaps}
...
\tag{7}
\]
Because \(N=50{,}001\) is odd, \(N-1\) is even, so \((N-1)(2N-1)\) is even and hence
\[
t_1+t_{2N-1}\equiv 0\pmod 2.
\tag{8}
\]

\subsection*{4. Impossibility below \(50{,}001\)}
Here \(N+1=50{,}002\). From (6),
\[
t_1+t_{2N-1}\ge 100{,}000.
\tag{9}
\]
If \(\max(t_1,t_{2N-1})\le 25{,}001\), then \(t_1+t_{2N-1}\le 100{,}000\).
